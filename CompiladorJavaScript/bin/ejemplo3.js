...
/******* José Luis Fuertes, 15, octubre, 2011 ***********/
...
function imprimePersona (new p)
{
	...
	resultado += ', con DNI nº ' + p.numero + ', ' + (p.masculino?'hombre':"mujer")
	resultado += ", de " + edad (p) + "años de edad, nació el "
...
function personas ()
{
	...
	document.write (2011-yo.nacimiento.a, " años de edad, nació el ")
...
function cuadrados (z[], dim)	
	/* no es necesario indicar el tamaño del vector que se pasa como parámetro */
{
	var s	// esta declaración oculta la s de demo
	for (s=0; s < dim; s++)
	{
		z[s] *= z[s]	/* z[s] = z[s] * z[s]	*/
